...
sourcesIndex["amelio"] = {"name":"","dirs":[{"name":"db","files":["connection.rs","mod.rs","models.rs","repositories.rs","schema.rs"]},{"name":"routes","files":["assets.rs","auth.rs","courses.rs","errors.rs","fairing.rs","mod.rs","tickets.rs","users.rs"]}],"files":["config.rs","dirs.rs","email.rs","fairings.rs","hashing.rs","language.rs","main.rs","models.rs","roles.rs","services.rs","templates.rs"]};
...
sourcesIndex["askama_rocket"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["email_address"] = {"name":"","files":["lib.rs"]};
sourcesIndex["email_encoding"] = {"name":"","dirs":[{"name":"body","files":["base64.rs","chooser.rs","mod.rs"]},{"name":"headers","files":["hex.rs","hex_encoding.rs","mod.rs","quoted_string.rs","rfc2047.rs","rfc2231.rs","utils.rs","writer.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["lettre"] = {"name":"","dirs":[{"name":"address","files":["envelope.rs","mod.rs","types.rs"]},{"name":"message","dirs":[{"name":"header","files":["content.rs","content_disposition.rs","content_type.rs","date.rs","mailbox.rs","mod.rs","special.rs","textual.rs"]},{"name":"mailbox","files":["mod.rs","types.rs"]}],"files":["attachment.rs","body.rs","mimebody.rs","mod.rs"]},{"name":"transport","dirs":[{"name":"smtp","dirs":[{"name":"client","files":["connection.rs","mod.rs","net.rs","tls.rs"]}],"files":["authentication.rs","commands.rs","error.rs","extension.rs","mod.rs","response.rs","transport.rs","util.rs"]},{"name":"stub","files":["mod.rs"]}],"files":["mod.rs"]}],"files":["error.rs","lib.rs"]};
...
sourcesIndex["unidirs"] = {"name":"","files":["lib.rs","local.rs","service.rs","simple.rs","unified.rs","user.rs"]};
...
sourcesIndex["whoami"] = {"name":"","files":["lib.rs","unix.rs"]};
